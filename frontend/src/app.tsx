        ...
        <div className='space-y-4'>
          ...
          {isGuestsInputOpen && (
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              ...
              <button className='bg-lime-300 text-lime-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400 duration-200'>
                Confirmar viagem
                <ArrowRight className='size-5' />
              </button>
            </div>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              <div className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2 hover:bg-zinc-700 duration-200'>
                <span className='text-zinc-300'>nardo@email.com</span>
              ...
              <div className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2 hover:bg-zinc-700 duration-200'>
                <span className='text-zinc-300'>juliano@email.com</span>
              ...
              <div className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2 hover:bg-zinc-700 duration-200'>
                <span className='text-zinc-300'>francisco@email.com</span>
              ...
              <div className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2 hover:bg-zinc-700 duration-200'>
                <span className='text-zinc-300'>luciana@email.com</span>
